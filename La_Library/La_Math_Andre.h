...
int Intersect(PARMLINE2D& p1, PARMLINE2D& p2, float& t1, float& t2)
{
...
int Intersect(PARMLINE2D& p1, PARMLINE2D& p2, VECTOR2D& pt)
{
...
float Compute(const VECTOR3D& pt, const PLANE3D& plane)
{
	// test if the point in on the plane, in the positive half space
	// or negative half space
...
int Intersect(PARMLINE3D& pline, PLANE3D& plane, float& t, VECTOR3D& pt)
{
