...
int Insert_OBJECT4DV1_RENDERLIST4DV12(RENDERLIST4DV1& rend_list,
	OBJECT4DV1& obj,
	int insert_local,
	int lighting_on)
{
	...
	for (int poly = 0; poly < obj.num_polys; poly++)
	{
		...
		POINT4D& vlist_old = curr_poly.vlist;
...
int Light_OBJECT4DV1_World16(OBJECT4DV1& obj,  // object to process
	CAM4DV1& cam,     // camera position
	LIGHTV1& lights,  // light list (might have more than one)
...
int Light_OBJECT4DV1_World(OBJECT4DV1& obj,  // object to process
	CAM4DV1& cam,     // camera position
	LIGHTV1& lights,  // light list (might have more than one)
	int max_lights)      // maximum lights in list
{
...
int Light_RENDERLIST4DV1_World16(RENDERLIST4DV1& rend_list,  // list to process
	CAM4DV1& cam,     // camera position
	LIGHTV1& lights,  // light list (might have more than one)
	int max_lights)      // maximum lights in list
{
...
int Light_RENDERLIST4DV1_World(RENDERLIST4DV1& rend_list,  // list to process
	CAM4DV1& cam,     // camera position
	LIGHTV1& lights,  // light list (might have more than one)
	int max_lights)      // maximum lights in list
{
...
void Sort_RENDERLIST4DV1(RENDERLIST4DV1& rend_list, int sort_method)
{
	...
	{
		qsort((void*)rend_list.poly_ptrs, rend_list.num_polys, sizeof(POLYF4DV1&), Compare_AvgZ_POLYF4DV1);
	} break;

	case SORT_POLYLIST_NEARZ: // - sorts on closest z vertex of each poly
	{
		qsort((void*)rend_list.poly_ptrs, rend_list.num_polys, sizeof(POLYF4DV1&), Compare_NearZ_POLYF4DV1);
	} break;

	case SORT_POLYLIST_FARZ:  //  - sorts on farthest z vertex of each poly
	{
		qsort((void*)rend_list.poly_ptrs, rend_list.num_polys, sizeof(POLYF4DV1&), Compare_FarZ_POLYF4DV1);
	} break;
